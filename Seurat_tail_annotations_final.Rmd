...
Non neural cells, excluding muscle, based on gene expression
```{r}
...
Muscle cells, based on expression
```{r}
...
# Mystery other population "cnfn+ Epidermal Cells" 50
FeaturePlot(tail, reduction = "umap.rpca",  features = c("ehf", "avd", "ptk6", "cnfn.1"))
```

Add names of cell types to clusters
```{r} 
